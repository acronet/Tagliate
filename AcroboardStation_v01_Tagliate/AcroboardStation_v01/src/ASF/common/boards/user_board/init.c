...
void board_init(void)
{
	...
	//Configure the SM100 switch
	ioport_configure_pin(EXTV33_SWITCH, IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
	
	//Configure the MB7260 switch
	ioport_configure_pin(LEVELGAUGE_SWITCH, IOPORT_DIR_OUTPUT | IOPORT_INIT_LOW);
